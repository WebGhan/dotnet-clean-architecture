...
public class AppointmentTests
{
    ...
    public void Constructor_StartTimeInThePast_ThrowsException()
    {
    ...
    [TestMethod]
    public void Cancel_CancellingAppointment_StatusIsCancelled()
    {
        var appointment = new Appointment(_patientId, _dentistId, _dentalOfficeId, _interval);
        appointment.Cancel();
    ...
    [TestMethod]
    [ExpectedException(typeof(BusinessRuleException))]
    public void Cancel_CancellingAppointment_ThrowIfStatusIsNotScheduled()
    {
        var appointment = new Appointment(_patientId, _dentistId, _dentalOfficeId, _interval);
        appointment.Cancel();
        appointment.Cancel();
    ...
    [TestMethod]
    public void Complete_CancellingAppointment_StatusIsCompleted()
    {
        var appointment = new Appointment(_patientId, _dentistId, _dentalOfficeId, _interval);
    ...
    [TestMethod]
    [ExpectedException(typeof(BusinessRuleException))]
    public void Complete_CancellingAppointment_ThrowIfStatusIsNotScheduled()
    {
        var appointment = new Appointment(_patientId, _dentistId, _dentalOfficeId, _interval);
        appointment.Cancel();
        appointment.Complete();
